...
project_type="reg_2_gpu_longer_cr"
...
for i in "${!input_dirs[@]}"; do
    ...
    echo ${input_dir} ${output_dir}
            #   --learning_rate=5e-6  \
            #--scale_lr 
    accelerate launch src/diffusers_training_text_embedding_cross_initialization.py \
...
python batch_evaluate.py \
    --config_path /workspace/custom_diffusion/custom-diffusion/batch_eval_output_reg_cr.json \
    --freeze_model "crossattn" \
    --uses_cr_embedding
